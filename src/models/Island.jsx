...
const Island = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
  ...
  const handlePointerDown = e => {
    ...
    // indentify type of event -> mouse or touch
  ...
  const handlePointerMove = e => {
    ...
    if (isRotating) {
      ...
      islandRef.current.rotation.y += delta * 0.01 * Math.PI; // working with circle
  ...
  useFrame(() => {
    if (!isRotating) {
      ...
      if (Math.abs(rotSpeed.current) < 0.001) rotSpeed.current = 0;
  ...
  useEffect(() => {
    ...
    // add event listeners for all pointer events
